...
## 3. Motivación
La motivación central para desarrollar **Chesster** surge del interés por las nuevas tecnologías integradas. Decidimos descartar nuestra propuesta inicial enfocada en la navegación móvil para concentrar todos nuestros esfuerzos en un desafío mucho más profundo y riguroso: la cinemática, el control de precisión y la visión artificial integrada.

Este proyecto nos apasiona porque llevar la teoría de los circuitos, el procesamiento de imágenes en hardware de recursos limitados (RAM limitada) y el control espacial en 3D a un escenario físico e interactivo es un reto técnico sumamente desafiante, pero gratificante a la hora de lograr el objetivo. Integrar un modelo de inteligencia artificial embebido para validar reglas y tomar decisiones autónomas nos permitirá aplicar directamente nuestras habilidades en programación de microcontroladores, manejo de periféricos (PWM, señales Step/Dir, I2C) y estructuración de datos, consolidando nuestra formación en ingeniería a través de un proyecto complejo y fuera de lo común.
